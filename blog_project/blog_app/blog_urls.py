...
urlpatterns = [
    ...
    path("user_post/<int:pk>", views.PostDetailView.as_view(), name='reading_post_page'),
    path("update_user_post/<int:pk>", views.PostUpdateView.as_view(), name='updating_post_page'),
    path("delete_post/<int:pk>", views.PostDeleteView.as_view(), name='delete_post_page')
]
